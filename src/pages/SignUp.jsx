          ...
          <div className='flex-1 p-8 md:p-12 lg:p-16'>
            ...
            <form onSubmit={handleSubmit} className='space-y-5'>
              ...
              <div className='relative flex items-center py-4'>
                ...
                <span className='flex-shrink mx-4 text-slate-400 text-sm uppercase tracking-wider font-medium'>
                  Or
                </span>
                <div className='flex-grow border-t border-slate-200 dark:border-slate-700'></div>
              </div>
              ...
              <button
                ...
                className='w-full flex items-center justify-center gap-3 py-3 border border-slate-200 dark:border-slate-700 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors text-slate-700 dark:text-slate-200 font-medium'
                type='button'
              >
